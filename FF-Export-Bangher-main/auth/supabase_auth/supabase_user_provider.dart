...
class BangherSupabaseUser extends BaseAuthUser {
  BangherSupabaseUser(this.user);
  User? user;
...
Stream<BaseAuthUser> bangherSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = BangherSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}

...
// Change: increased side padding by 50% (16 → 24) via _screenHPad.
// Plus: full-width gray bar behind name/age on the photo, taller and animated.
// Web swipe kept via explicit PageScrollPhysics.
...
class _UserProfilePageState extends ConsumerState<UserProfilePage> {
  ...
  // Design tokens
  static const double _screenHPad = 24; // ← increased outer horizontal padding
                                ...
                                const Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 6),
                                      Text('Complete your profile to experience the best dating!',
                                ...
                                AspectRatio(
                                  ...
                                  child: ScrollConfiguration(
                                    ...
                                    child: PageView.builder(
                                      physics: const PageScrollPhysics(), // ← explicit physics (web-friendly)
